...
parser.add_argument('--exp', type=str,
                    default='LA_GMABS_HERD', help='experiment_name')
...
def Inference(FLAGS):
    snapshot_path = "../model_active/{}/{}".format(FLAGS.exp, FLAGS.model)
    num_classes = 2
    test_save_path = "../model_active/{}/{}_Prediction".format(FLAGS.exp, FLAGS.model)
...
if __name__ == '__main__':
    ...
    # save the metric
    with open("../model_active/{}/{}_Prediction/metric.txt".format(FLAGS.exp, FLAGS.model), "a") as f:
        f.writelines("dice, jc, hd, asd:\n")
