...
class DCPA_3D(nn.Module):
    def __init__(self, n_channels=3, n_classes=2, n_filters=16, normalization='none', has_dropout=False,
                 has_residual=False):
        super(DCPA_3D, self).__init__()

        self.encoder = VNet_encoder(n_channels, n_classes, n_filters, normalization, has_dropout, has_residual)
        self.decoder_transpose = VNet_decoder(n_channels, n_classes, n_filters, normalization, has_dropout, has_residual, 0)
        self.decoder_linear = VNet_decoder(n_channels, n_classes, n_filters, normalization, has_dropout, has_residual, 1)
